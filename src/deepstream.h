...
std::string start_time_locals = "None";
...
namespace Machine_utilisation {
  class Manchine_util {
    ...
    public:
      ...
      static void
      addDisplayMachine_utilisation_data(gpointer batch_meta_data, gpointer frame_meta_data , std::string start_time);
